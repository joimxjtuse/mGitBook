...
直到2014年接触了RxJava后这一情况才有所缓解。通过在几个示例项目上使用RxJava重构，我们意识到这才是解决“回调地狱”问题的终极解决方案（如果你不熟悉**反应式编程**，可以阅读这篇文章：[https://gist.github.com/staltz/868e7e9bc2a7b8c1f754](https://gist.github.com/staltz/868e7e9bc2a7b8c1f754）。)）。
